...
import {
  Alert, Image, Modal, Text, TextInput, TouchableOpacity, View, Platform,
  ...
  const handleSubmitReport = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPhoto(null); setDetail(""); setDate(null); setLocation(null); setVisible(false); setModalType(null);
      } else {
