...
import os
import requests
# 상위 폴더 (PHITEST)를 import 경로에 추가
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))
from backend.speechDAO import SpeechDAO

dao = SpeechDAO()
#######################################################################################3

# 경로 확인 (선택 사항)
audio_path = "C:/Lee/whisper_gpt/AI/audioSample.mp3"
            ...
            "data_sources": [
                {
                    ...
                    "parameters": {
                        ...
                        "authentication": {
                            "type": "api_key",
                            "key": "", # 따로 ai search리소스 찾아 들어가서 설정 - 키 - 기본 관리자 키
                        },
